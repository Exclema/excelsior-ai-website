...
// Assuming you have configured tailwind.config.js with:
// fontFamily: {
//   'oxanium': ['Oxanium', 'sans-serif'],
//   'lato': ['Lato', 'sans-serif'],
//   'sans': ['Lato', 'sans-serif'], // Setting Lato as the default sans font
// },
...
                  className={`capitalize transition-colors font-lato ${ // Applied font-lato to navigation links
...
                  key={section}
                  onClick={() => scrollToSection(section)}
                  className={`block w-full text-left capitalize py-2 font-lato ${ // Applied font-lato to mobile links
...
          </h1>
          <p className={`text-xl md:text-3xl font-semibold mb-4 font-lato ${darkMode ? 'text-blue-400' : 'text-blue-600'}`}>
            Smarter Solutions. Stronger Business.
          </p>
          <p className={`text-lg md:text-xl max-w-3xl mx-auto mb-8 font-lato ${darkMode ? 'text-slate-300' : 'text-slate-600'}`}>
            We deliver advanced AI automation, chatbots, and workflow systems designed to optimize how your business operates.
          </p>
          <button
            onClick={() => scrollToSection('contact')}
            className="inline-flex items-center px-8 py-4 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-lg font-lato" // Applied font-lato to button text
          >
            Get Started
...
          <h2 className={`text-4xl font-bold text-center mb-4 font-oxanium ${darkMode ? 'text-white' : 'text-slate-900'}`}>
            Our Services
          </h2>
          <p className={`text-center mb-12 max-w-2xl mx-auto font-lato ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>
...
                  {service.icon}
                </div>
                <h3 className={`text-xl font-bold mb-3 font-oxanium ${darkMode ? 'text-white' : 'text-slate-900'}`}>
                  {service.title}
                </h3>
                <p className={`font-lato ${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>
                  {service.description}
                </p>
              </div>
            ))}
...
            <div>
              <h2 className={`text-4xl font-bold mb-6 font-oxanium ${darkMode ? 'text-white' : 'text-slate-900'}`}>
                About Us
              </h2>
              <p className={`text-lg mb-6 font-lato ${darkMode ? 'text-slate-300' : 'text-slate-600'}`}>
...
              </p>
              <p className={`text-lg font-lato ${darkMode ? 'text-slate-300' : 'text-slate-600'}`}>
...
            }`}>
              <h3 className={`text-2xl font-bold mb-6 font-oxanium ${darkMode ? 'text-white' : 'text-slate-900'}`}>
                Why Choose Us
              </h3>
...
                    </div>
                    <span className={`text-lg font-lato ${darkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                      {benefit}
                    </span>
                  </li>
                ))}
...
          <h2 className="text-4xl font-bold text-white mb-6 text-center font-oxanium">Get In Touch</h2>
          <p className="text-xl text-slate-300 mb-12 text-center font-lato">
            Ready to transform your business with AI? Let's talk.
          </p>

          {/* Contact Cards */}
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="p-6 rounded-xl text-center bg-slate-800 font-lato">
...
              </a>
              {/* The paragraph/link text here already implicitly uses font-lato if you set it as the default sans-serif font in config. */}
            </div>
...
            </h3>
            
            {/* Success/Error Message (No specific font class needed here, usually inherits from body) */}
            {formStatus.message && (
              <div className={`mb-6 p-4 rounded-lg font-lato ${ // Added font-lato just to be safe
...
              {/* Name Field */}
              <div>
                <label htmlFor="name" className={`block text-sm font-semibold mb-2 font-lato ${darkMode ? 'text-slate-200' : 'text-slate-700'}`}>
                  Name *
                </label>
                <input
                  type="text"
...
                  required
                  className={`w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition border font-lato ${ // Applied font-lato to input
                    darkMode 
...
              {/* Email Field */}
              <div>
                <label htmlFor="email" className={`block text-sm font-semibold mb-2 font-lato ${darkMode ? 'text-slate-200' : 'text-slate-700'}`}>
                  Email *
                </label>
                <input
                  type="email"
...
              {/* Message Field */}
              <div>
                <label htmlFor="message" className={`block text-sm font-semibold mb-2 font-lato ${darkMode ? 'text-slate-200' : 'text-slate-700'}`}>
                  Message *
                </label>
                <textarea
                  id="message"
...
                  required
                  rows={5}
                  className={`w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition resize-none border font-lato ${ // Applied font-lato to textarea
                    darkMode 
                      ? 'bg-slate-700 border-slate-600 text-white placeholder-slate-400' 
                      : 'bg-white border-slate-300 text-slate-900 placeholder-slate-400'
                  }`}
...
                className="w-full bg-blue-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-slate-400 disabled:cursor-not-allowed flex items-center justify-center font-lato" // Applied font-lato to button text
              >
                {isSubmitting ? (
                  'Sending...'
                ) : (
...
        <div className="max-w-7xl mx-auto text-center text-slate-400 font-lato">
